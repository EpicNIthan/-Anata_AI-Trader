...
class Settings:
    ...
    raw_payload_retention_hours: int = field(default_factory=lambda: _int("RAW_PAYLOAD_RETENTION_HOURS", 24))
    live_update_retention_hours: int = field(default_factory=lambda: _int("LIVE_UPDATE_RETENTION_HOURS", 12))
    account_equity_retention_days: int = field(default_factory=lambda: _int("ACCOUNT_EQUITY_RETENTION_DAYS", 7))
    raw_news_text_retention_days: int = field(default_factory=lambda: _int("RAW_NEWS_TEXT_RETENTION_DAYS", 7))
    ...
    raw_external_event_retention_days: int = field(default_factory=lambda: _int("RAW_EXTERNAL_EVENT_RETENTION_DAYS", 7))
